...
sports_df['price_label'] = pd.qcut(sports_df['listing_price'], 4, labels=price_labels)
...
sports_df['description_length'] = pd.cut(sports_df['description_length'], bins=limits, labels=desc_labels)
